    ...
    public class FireBaseScript : MonoBehaviour
    {
        ...
        public static void CreateExplosion(Vector3 pos, float radius, float force)
        {
            ...
            foreach (Collider h in objects)
            {
                ...
                if (h.transform.gameObject.GetComponent<laserBehavior>() == null)
                {
                    if (h.gameObject.GetComponent<playerBehavior>() != null)
                    {
                        h.gameObject.GetComponent<playerBehavior>().damageMessage(20);
                    }
                    else if (h.gameObject.GetComponent<Aibehavoir>() != null)
                    {
                        //Debug.Log("Hi there 2");
                        h.gameObject.GetComponent<Aibehavoir>().damageMessage(20);
                    }
